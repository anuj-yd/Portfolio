...
import dsaData from '../../../data/dsa-stats.json';
import BouncyText from '../../ui/BouncyText';

const DSAProfile = () => {
    const chartData = dsaData.map(d => ({ name: d.platform, value: d.problemsSolved }));
    const totalSolved = dsaData.reduce((acc, curr) => acc + curr.problemsSolved, 0);

    return (
        <section id="dsa" className="py-10 relative overflow-hidden bg-white/50">
                    ...
                    >
                        {dsaData.map((stat, i) => (
                            ...
                            >
                                ...
                                <h3
                                    className="text-xl font-black mb-4 uppercase tracking-widest px-4 py-1 rounded-full text-white"
                                ...
                                <div
                                    className="mt-6 px-4 py-1.5 rounded-full text-[11px] font-black uppercase tracking-wider border-2 border-[#1A1A1A]"
                                    style={{
